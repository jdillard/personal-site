...
<script>
  ...
  var hourly_REV_58_16 = {"correlationId":"588fc13f","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/588fc13f"}
  var crags_config = [
  {
    "name": "Mammoth Lakes",
