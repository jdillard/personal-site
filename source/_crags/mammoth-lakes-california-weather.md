...
<script>
  ...
  var hourly_REV_58_16 = {"correlationId":"d6daa61","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/d6daa61"}
  var crags_config = [
  {
    "name": "Mammoth Lakes",
