...
<script>
  ...
  var hourly_REV_58_16 = {"correlationId":"1eb33f2f","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1eb33f2f"}
  var crags_config = [
  {
    "name": "Mammoth Lakes",
