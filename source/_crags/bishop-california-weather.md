...
<script>
  ...
  var hourly_VEF_14_168 = {"correlationId":"1735f62b","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1735f62b"}
  var crags_config = [
  {
    "name": "Bishop",
