...
<script>
  ...
  var hourly_VEF_14_168 = {"correlationId":"16afcef9","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/16afcef9"}
  var crags_config = [
  {
    "name": "Bishop",
