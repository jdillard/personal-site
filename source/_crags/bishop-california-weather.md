...
<script>
  ...
  var hourly_VEF_14_168 = {"correlationId":"4a32faaa","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/4a32faaa"}
  var crags_config = [
  {
    "name": "Bishop",
