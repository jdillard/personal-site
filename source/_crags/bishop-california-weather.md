...
<script>
  ...
  var hourly_VEF_14_168 = {"correlationId":"1a1962a","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1a1962a"}
  var crags_config = [
  {
    "name": "Bishop",
