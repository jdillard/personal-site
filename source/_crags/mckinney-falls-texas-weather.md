...
<script>
  ...
  var hourly_EWX_156_86 = {"correlationId":"5d8de72c","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/5d8de72c"}
  var crags_config = [
  {
    "name": "McKinney Falls",
