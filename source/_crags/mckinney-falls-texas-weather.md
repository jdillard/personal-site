...
<script>
  ...
  var hourly_EWX_156_86 = {"correlationId":"f6bc75f","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/f6bc75f"}
  var crags_config = [
  {
    "name": "McKinney Falls",
