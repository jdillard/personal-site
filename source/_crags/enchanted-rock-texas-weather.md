...
<script>
  ...
  var hourly_EWX_114_101 = {"correlationId":"1e2e8f3","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1e2e8f3"}
  var crags_config = [
  {
    "name": "Enchanted Rock",
