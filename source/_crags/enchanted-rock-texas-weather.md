...
<script>
  ...
  var hourly_EWX_114_101 = {"correlationId":"42a9e4ae","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/42a9e4ae"}
  var crags_config = [
  {
    "name": "Enchanted Rock",
