...
<script>
  ...
  var hourly_EWX_114_101 = {"correlationId":"aa5389a","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/aa5389a"}
  var crags_config = [
  {
    "name": "Enchanted Rock",
