...
<script>
  ...
  var hourly_EWX_114_101 = {"correlationId":"35a57add","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/35a57add"}
  var crags_config = [
  {
    "name": "Enchanted Rock",
