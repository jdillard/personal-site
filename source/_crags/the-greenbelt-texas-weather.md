...
<script>
  ...
  var hourly_EWX_153_89 = {"correlationId":"cd87a6d","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/cd87a6d"}
  var crags_config = [
  {
    "name": "The Greenbelt",
