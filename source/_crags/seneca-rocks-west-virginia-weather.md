...
<script>
  ...
  var hourly_LWX_14_57 = {"correlationId":"b8e7b13","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/b8e7b13"}
  var crags_config = [
  {
    "name": "Seneca Rocks",
