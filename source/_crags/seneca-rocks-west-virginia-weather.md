...
<script>
  ...
  var hourly_LWX_14_57 = {"correlationId":"fb26ace","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/fb26ace"}
  var crags_config = [
  {
    "name": "Seneca Rocks",
