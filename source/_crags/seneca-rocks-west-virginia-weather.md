...
<script>
  ...
  var hourly_LWX_14_57 = {"correlationId":"5a4d07","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/5a4d07"}
  var crags_config = [
  {
    "name": "Seneca Rocks",
