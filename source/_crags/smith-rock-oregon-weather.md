...
<script>
  ...
  var hourly_PDT_43_53 = {"correlationId":"b4a8e75","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/b4a8e75"}
  var crags_config = [
  {
    "name": "Smith Rock",
