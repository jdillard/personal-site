...
<script>
  ...
  var hourly_EPZ_116_60 = {"correlationId":"165d0bd6","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/165d0bd6"}
  var crags_config = [
  {
    "name": "Hueco Tanks",
