...
<script>
  ...
  var hourly_OTX_35_103 = {"correlationId":"1e7c286c","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1e7c286c"}
  var crags_config = [
  {
    "name": "Icicle Creek",
