...
<script>
  ...
  var hourly_OTX_35_103 = {"correlationId":"4508a1e5","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/4508a1e5"}
  var crags_config = [
  {
    "name": "Icicle Creek",
