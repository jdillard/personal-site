...
<script>
  ...
  var hourly_OTX_35_103 = {"correlationId":"44a411d5","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/44a411d5"}
  var crags_config = [
  {
    "name": "Icicle Creek",
