...
<script>
  ...
  var hourly_EWX_141_93 = {"correlationId":"75d7e8f","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/75d7e8f"}
  var crags_config = [
  {
    "name": "Reimer's Ranch",
