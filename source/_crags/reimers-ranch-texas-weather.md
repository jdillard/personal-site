...
<script>
  ...
  var hourly_EWX_141_93 = {"correlationId":"d7a16a8","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/d7a16a8"}
  var crags_config = [
  {
    "name": "Reimer's Ranch",
