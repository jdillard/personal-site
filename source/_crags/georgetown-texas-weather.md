...
<script>
  ...
  var hourly_EWX_157_106 = {"correlationId":"210edca","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/210edca"}
  var crags_config = [
  {
    "name": "Georgetown",
