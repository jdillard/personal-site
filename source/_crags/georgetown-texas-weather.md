...
<script>
  ...
  var hourly_EWX_157_106 = {"correlationId":"caee2f56","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/caee2f56"}
  var crags_config = [
  {
    "name": "Georgetown",
