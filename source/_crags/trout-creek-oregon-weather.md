...
<script>
  ...
  var hourly_PDT_48_73 = {"correlationId":"f5cbc7d9","title":"Service Unavailable","type":"https://api.weather.gov/problems/ServiceUnavailable","status":503,"detail":"An upstream data source is temporarily unavailable. Please try again later.","instance":"https://api.weather.gov/requests/f5cbc7d9"}
  var crags_config = [
  {
    "name": "Trout Creek",
