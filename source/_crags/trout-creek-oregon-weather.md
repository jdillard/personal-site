...
<script>
  ...
  var hourly_PDT_48_73 = {"correlationId":"1ed5ddfe","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1ed5ddfe"}
  var crags_config = [
  {
    "name": "Trout Creek",
