...
<script>
  ...
  var hourly_SEW_123_109 = {"correlationId":"67ddc53","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/67ddc53"}
  var crags_config = [
  {
    "name": "Mount Erie",
