...
<script>
  ...
  var hourly_EWX_145_98 = {"correlationId":"86ceb10","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/86ceb10"}
  var crags_config = [
  {
    "name": "Pace Bend Park",
