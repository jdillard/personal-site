...
<script>
  ...
  var hourly_MRX_19_12 = {"correlationId":"1270f274","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/1270f274"}
  var crags_config = [
  {
    "name": "Foster Falls",
