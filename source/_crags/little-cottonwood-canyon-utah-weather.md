...
<script>
  ...
  var hourly_SLC_102_165 = {"correlationId":"f45d4a2","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/f45d4a2"}
  var crags_config = [
  {
