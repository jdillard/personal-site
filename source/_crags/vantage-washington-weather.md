...
<script>
  ...
  var hourly_OTX_54_74 = {"correlationId":"2c18f35f","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/2c18f35f"}
  var crags_config = [
  {
    "name": "Vantage",
