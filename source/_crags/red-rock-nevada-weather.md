...
<script>
  ...
  var hourly_VEF_111_97 = {"correlationId":"dee6a53","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/dee6a53"}
  var crags_config = [
  {
    "name": "Red Rock",
