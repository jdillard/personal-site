...
<script>
  ...
  var hourly_GJT_60_82 = {"correlationId":"5ebdfb6d","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/5ebdfb6d"}
  var crags_config = [
  {
    "name": "Moab",
