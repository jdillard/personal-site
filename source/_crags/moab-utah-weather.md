...
<script>
  ...
  var hourly_GJT_60_82 = {"correlationId":"20aea76f","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/20aea76f"}
  var crags_config = [
  {
    "name": "Moab",
