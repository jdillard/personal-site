...
<script>
  ...
  var hourly_GJT_60_82 = {"correlationId":"8e5fd7ae","title":"Unexpected Problem","type":"https://api.weather.gov/problems/UnexpectedProblem","status":500,"detail":"An unexpected problem has occurred.","instance":"https://api.weather.gov/requests/8e5fd7ae"}
  var crags_config = [
  {
    "name": "Moab",
